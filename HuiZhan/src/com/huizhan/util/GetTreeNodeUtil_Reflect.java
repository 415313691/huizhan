...
public class GetTreeNodeUtil_Reflect {
	...
	/***
		 ...
		 * @author jml 
		 * @param allList
		 * @return allist为构造属性数据，obj 为实体对应包全路径，key为主键名字，首字母大写，parentid为父类id首字母大写
	...
	public static List  getOrgsTree(List allList,String obj,String key,String parentid) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		for(int i=0;i<parents.size();i++){
			...
			//查询第一级菜单
				rootNode = constructTree(rootNode, allList, 0,obj,key,parentid);
	...
	public static Object constructTree(Object rootNode, List<Object> orgList, int rootLevel,String path,String key,String parentid) throws ClassNotFoundException, InstantiationException, IllegalAccessException{
		...
		for(int j=0; j<childNodeList.size();j++){
			constructTree(childNodeList.get(j), orgList, ++rootLevel,path,key,parentid);
			--rootLevel;
		}
		return rootNode;
	}
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		allList = GetTreeNodeUtil_Reflect.getOrgsTree(allList, "com.all.entitys.ProCategory","ProCategoryId","ParentId");
	*/
	}
}
